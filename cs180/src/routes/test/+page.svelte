...
<div class="flex justify-center p-12 space-y-4 max-w-10xl">
    <div class="flex-col w-10/12 max-w-5xl text-center bg-gray-100 rounded-lg shadow-lg p-8">
        ...
        />
        <button class="mt-4 px-6 py-2 bg-cyan-600 text-white rounded-lg shadow hover:bg-blue-700 disabled:opacity-50">
            Model A
        </button>
        <button class="mt-4 px-6 py-2 bg-violet-600 text-white rounded-lg shadow hover:bg-blue-700 disabled:opacity-50">
            Model B
        </button>
